...
public class WebHostRegisteringProcessor extends RegisteringProcessor {
    ...
    public RegistryEntry registryEntry(DeploymentPhaseContext context) {
        ...
        Host host = ((Value<Host>)registry.
                getService(UndertowService.virtualHostName("default-server",
                        WebUtil.hostNameOfDeployment( warMetaData, "default-host" )))). 
                getValue();
        
        return new RegistryEntry( "web-host", host);
    }
}
