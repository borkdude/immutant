...
public class WebContainerRegisteringProcessor extends RegisteringProcessor {
    ...
    public RegistryEntry registryEntry(DeploymentPhaseContext context) {
        ...
        ServletContainer container = ((Value<ServletContainerService>)registry.
                getService(UndertowService.SERVLET_CONTAINER.append("default"))).
                getValue().getServletContainer();
        
        return new RegistryEntry( "web-container", container);
    }
}
